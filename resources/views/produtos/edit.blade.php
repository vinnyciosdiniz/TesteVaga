        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('produtos.index') }}" enctype="multipart/form-data">
                        Voltar</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="quantidade" value="{{ $product->quantidade }}" class="form-control"
